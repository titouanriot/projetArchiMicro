...
('Jane', 'Doe', 'jane.doe@example.com', '1990-07-12', 'qwerty123', FALSE),
('Bob', 'Smith', 'bob.smith@example.com', '1978-03-22', 'letmein123', TRUE),
('Alice', 'Jones', 'alice.jones@example.com', '1995-11-02', 'pass123word', FALSE),
('David', 'Brown', 'david.brown@example.com', '1983-09-14', 'brown123', FALSE);

INSERT INTO Groupe (group_name, owner)
VALUES
('Movie lovers', 1),
('TV series fans', 2),
('Action movies', 3),
...
INSERT INTO Movie(original_title, title, language, category, poster_path, release_date, runtime, vote_average, vote_count, overview)
VALUES 
...
INSERT INTO BelongTo (id_user, id_group)
VALUES
(1,1),
(2,2),
(3,3),
...
INSERT INTO Watched (id_user, id_movie, appreciation)
VALUES
(1,1,5),
(1,2,4),
(1,3,3),
...
INSERT INTO DirectedBy (id_director, id_movie)
VALUES
(1,1),
(2,2),
(3,3),
...
INSERT INTO HasGenre (id_genre, id_movie)
VALUES
(1,1),
(2,2),
(3,3),
